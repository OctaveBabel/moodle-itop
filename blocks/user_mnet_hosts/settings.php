...
$settings->add(new admin_setting_configtext('block_u_m_h_displaylimit', get_string('displaylimit', 'block_user_mnet_hosts'),
       get_string('configdisplaylimit', 'block_user_mnet_hosts'), 40));
