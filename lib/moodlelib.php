...
function cleardoubleslashes ($path) {
    // PATCH : ITOP - Allow UNC path (see https://tracker.moodle.org/browse/MDL-38858)
    global $CFG;
    require_once($CFG->dirroot. '/local/ent_installer/patch/function.php');
    return ent_installer_clear_double_slashes($path);
    // /PATCH
}
