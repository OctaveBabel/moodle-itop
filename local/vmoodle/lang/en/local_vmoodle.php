...
$string['errorsqlsrvdumpscriptnotdefined'] = 'Global var $CFG::local_vmoodle_cmd_sqlsrvdump not defined in config.php';
...
$string['changeprefixforsqlsrvnotimplemented'] = 'A subnetwork nodes cannot have a different table prefix than the master node into SQLServer';
