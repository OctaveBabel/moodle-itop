...
$string['errorsqlsrvdumpscriptnotdefined'] = 'Variable globale $CFG::local_vmoodle_cmd_sqlsrvdump non définie dans config.php';
...
$string['changeprefixforsqlsrvnotimplemented'] = 'Une instance du sous-réseau ne peut avoir un prefixe de table différent du Moodle chapeau avec SQLServer.';
