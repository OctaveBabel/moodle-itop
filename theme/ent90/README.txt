...
This document describes how to copy and customise the ent90 (bootstrapbase) theme so that
...
From your Moodle theme directory right click on ent90 and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of ent90.
...
underscores. For the purpose of this tutorial we will call the theme 'ent90theme'.

On opening 'ent90theme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case ent90. So using the above list as
a guide, search through and change all the instances of the theme name
'ent90' to 'ent90theme'. This includes the filename of the lang/en/theme_ent90.php.
You need to change this to 'theme_ent90theme.php'.
...
and then click on (ent90theme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the ent90 theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > ent90

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/ent90_theme
