...
This document describes how to copy and customise the itop (bootstrapbase) theme so that
...
From your Moodle theme directory right click on itop and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of itop.
...
underscores. For the purpose of this tutorial we will call the theme 'itoptheme'.

On opening 'itoptheme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case itop. So using the above list as
a guide, search through and change all the instances of the theme name
'itop' to 'itoptheme'. This includes the filename of the lang/en/theme_itop.php.
You need to change this to 'theme_itoptheme.php'.
...
and then click on (itoptheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the itop theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > itop

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/itop_theme
